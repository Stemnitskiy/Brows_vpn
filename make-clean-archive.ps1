...
function Write-ArchiveReadme {
    ...
    $lines = @(
        ...
        ''
        'After unpack:'
        '  1. Download xray.exe into proxy-service/xray-core/ (see xray-core/README.md)'
        '  2. Load extension in Chrome, copy Extension ID'
        '  3. cd proxy-service && .\install.ps1 -ExtensionId YOUR_ID -Build'
        '  4. Restart Chrome'
        ''
        'Tests:'
